...
> 例如：hello.c![[../T_Box/附件/Pasted image 20221211232419.png]]
...
![[../T_Box/附件/Pasted image 20221211232758.png]]
...
![[../T_Box/附件/Pasted image 20221212111824.png]]
...
==典型的系统硬件组成==
![[../T_Box/附件/Pasted image 20221212125440.png]]
...
![[../T_Box/附件/Pasted image 20221212130552.png]]
...
![[../T_Box/附件/Pasted image 20221212131550.png]]

3. hello目标代码和数据加载到主存之后，处理器开始执行hello程序中的main程序中的及其语言指令。这些指令将"hello,world\n”字符串中的字节从主存复制到寄存器文件，再从寄存器文件中复制到显示设备，最终显示在屏幕上。
![[../T_Box/附件/Pasted image 20221212131847.png]]
## 5. 高速缓存的重要性
...
>例子：
>![[../T_Box/附件/Pasted image 20221212132618.png]]

## 6. 存储器设备的层次结构
![[../T_Box/附件/Pasted image 20221212132813.png]]
...
![[../T_Box/附件/Pasted image 20221212133123.png]]
...
![[../T_Box/附件/Pasted image 20221212134135.png]]
...
![[../T_Box/附件/Pasted image 20221212134605.png]]
...
![[../T_Box/附件/Pasted image 20221212135627.png]]
...
因此，总的执行时间应为
![[../T_Box/附件/Pasted image 20221212140216.png]]

![[../T_Box/附件/Pasted image 20221212140225.png]]
![[../T_Box/附件/Pasted image 20221212140327.png]]
...
![[../T_Box/附件/Pasted image 20221212141404.png]]
...
![[../T_Box/附件/Pasted image 20221212142733.png]]
...
![[../T_Box/附件/Pasted image 20221213152712.png]]
...
>![[../T_Box/附件/Pasted image 20221213153113.png]]
...
利用**辗转相除法**
![[../T_Box/附件/Pasted image 20221213154409.png]]

#### 十六进制进制转十进制
![[../T_Box/附件/Pasted image 20221213154505.png]]
...
![[../T_Box/附件/Pasted image 20221213162008.png]]
...
#### 小端法
最低有效字节存储在前面
![[../T_Box/附件/Pasted image 20221213171150.png]]
...
#### 大端法
最高有效字节存储在最前面
![[../T_Box/附件/Pasted image 20221213171144.png]]
...
![[../T_Box/附件/Pasted image 20221214194600.png]]
...
> 书P31图2-4的小思考 
> ![[../T_Box/附件/Pasted image 20221214195622.png]]
...
#### 小小例题
![[../T_Box/附件/Pasted image 20221214200837.png]]![[../T_Box/附件/Pasted image 20221214200844.png]]
...
![[../T_Box/附件/Pasted image 20221214203631.png]]
...
```
![[../T_Box/附件/Pasted image 20221214204303.png]]
...
![[../T_Box/附件/Pasted image 20221214204519.png]]

#### 位向量的运算

**二进制数之间每一位进行运算**

![[../T_Box/附件/Pasted image 20221214204649.png]]
...
- 32位
![[../T_Box/附件/Pasted image 20221214211514.png]]

- 64位
![[../T_Box/附件/Pasted image 20221214211538.png]]
...
![[../T_Box/附件/Pasted image 20221216142312.png]]

[图形化表示方法：](https://www.bilibili.com/video/BV1ba4y1E7qy#t=145.788479)
![[../T_Box/附件/Pasted image 20221216142444.png]]
...
*无符号数最小值均为0*
##### 无符号数
![[../T_Box/附件/Pasted image 20221216151422.png]]

##### 有符号数
**最大值**
![[../T_Box/附件/Pasted image 20221216151504.png]]

**最小值**
![[../T_Box/附件/Pasted image 20221216151555.png]]
**符号位为1，其余均为0**
>因为只有最高位（符号位）表示负权重，其余位都是正权重，如果其他位有1将使得数据变大。


###### 有符号数-1（负1）
![[../T_Box/附件/Pasted image 20221216151738.png]]
...
![[../T_Box/附件/Pasted image 20221216154542.png]]
**结论：-12345是12345的补码**
>原码：十进制数对应的二进制
>正数的原码补码反码均相同。
...
#### 有符号数转化为无符号数
![[../T_Box/附件/Pasted image 20221216155355.png]]
	**结论：（上图式子移项得到）**
	![[../T_Box/附件/Pasted image 20221216155509.png]]

**有符号数到无符号数的函数映射T2U：** 假设x为一个有符号数
![[../T_Box/附件/Pasted image 20221216160325.png]] ^79d93f
...
![[../T_Box/附件/Pasted image 20221216160917.png]]
...
![[../T_Box/附件/Pasted image 20221216161202.png]]
...
![[../T_Box/附件/Pasted image 20221216162854.png]]

**证明：B2T<sub>w+1</sub>=等于=B2T<sub>w+1</sub>** 。（相减）
![[../T_Box/附件/Pasted image 20221216163110.png]]
...
书中表达式：
![[../T_Box/附件/Pasted image 20221216163708.png]]
![[../T_Box/附件/Pasted image 20221216163744.png]]
...
![[../T_Box/附件/Pasted image 20221217224313.png]]
...
![[../T_Box/附件/Pasted image 20221217230404.png]]
...
#### 有符号数的乘法运算
![[../T_Box/附件/Pasted image 20221218144431.png]]
**即保留w位，对计算结果截断[[#无符号数转换成更小的数据类型|取模]]操作。**


#### 无符号数的乘法运算
![[../T_Box/附件/Pasted image 20221218150628.png]]
**在无符号数乘法的基础上，取模之后再转化为有符号数。**

>有符号数乘法和无符号数乘法，截断之后的解释不同，但是**二进制位级表示是相同的。**

![[../T_Box/附件/Pasted image 20221218151906.png]]
   
**无符号数的乘法**
$$x=x*2^k$$
上述式子可以看成，x向左移k位。
**证明如下：左移k位等一乘以2<sup>k</sup>**** 
![[../T_Box/附件/Pasted image 20221218152837.png]]
...
![[../T_Box/附件/Pasted image 20221218154152.png]]


#### 无符号数除法
1. 假设有一个无符号数x，位模式如下：
![[../T_Box/附件/Pasted image 20221218154242.png]]
2. 将x右移k位([[#^bebe94|逻辑右移]])，得到x1
 ![[../T_Box/附件/Pasted image 20221218154455.png]]
3. 被移出去的低k位，记为x2
![[../T_Box/附件/Pasted image 20221218154641.png]]
4.  将x1左移k位(乘以2<sup>k</sup>)，得到x3
![[../T_Box/附件/Pasted image 20221218154724.png]]
5. 将x3+x2，得到x4，**x4等于x**
![[../T_Box/附件/Pasted image 20221218154836.png]]
...
对于-12340移动不同数位的结果如下：
![[../T_Box/附件/Pasted image 20221218155729.png]]
*-772是向下舍入的结果，期望结果是-771（逼近0）*
**解决方法，引入偏置，计算结果加上偏置值，修正不合适的舍入**

![[../T_Box/附件/Pasted image 20221218160233.png]]
**偏置值为$(1<<k)-1=2^k-1,$**
>k=4时，偏置值=(1<<4)-1=15
>k=8时，偏置值=(1<<8)-1=255

原数x加上偏置值相当于$+2^k-1,$再除$2^k$,$(x+2^k-1)/2^k=[x/2^k],$能保持结果不变，且保持向上取整。页面P73
![[../T_Box/附件/Pasted image 20221218171652.png]]
![[../T_Box/附件/Pasted image 20221218174546.png]]

## 浮点数

### 定长二进制小数
![[../T_Box/附件/Pasted image 20221220205801.png]]
...
![[../T_Box/附件/Pasted image 20221220211348.png]]
